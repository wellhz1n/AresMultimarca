...
const Header: React.FC = () => {
  const navLinks = [
    ...
    { name: 'Venda seu Carro', href: '#' },
    { name: 'Financiamento', href: '#' },
    { name: 'Contato', href: '#contato' },
  ];

  return (
    <header className="sticky top-0 z-50 bg-zinc-900/80 backdrop-blur-sm shadow-md shadow-yellow-600/10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
             <a href="#" className="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-zinc-900 bg-yellow-500 hover:bg-yellow-600 transition-colors duration-300">
